...
//
	...
	9 => [7, 'title' => clienttranslate('COLUMBUS’ SECOND VOYAGE'), clienttranslate('+7 Soldiers* & +6 Settlers'), clienttranslate('Place in the same area where Columbus is located. If Columbus is not in any area, place freely between areas 5, 6 & 15.')],
	10 => [1, 'title' => clienttranslate('GUACANAGARÍ’S SUPPORT'), clienttranslate('-3 Tainos, +3 Settlers + Guacanagarí'), clienttranslate('Remove up to 3 Tainos in one area and place Guacaganarí on its Spanish side +3 Settlers. Roll a die at the end of each turn: (6) Flip Guacaganarí and move him to the most crowded Indigenous controlled area without restrictions.')],
	11 => [4, 'title' => clienttranslate('BARTHOLOMEW COLUMBUS'), clienttranslate('+3 Soldiers* & +2 Settlers'), clienttranslate('Place in any Spanish controlled area.')],
	12 => [6, 'title' => clienttranslate('SMALLPOC EPIDEMIC'), clienttranslate('Roll 1 die per each Taino & Carib unit'), clienttranslate('(1-3) Eliminate unit; (4-6) No effect. If target units are 2 or more areas from any Spanish controlled area or Rebel units, apply a die roll modifier of +1. No effect on Rebel units nor Leaders.')],
	13 => [4, 'title' => clienttranslate('DIEGO MÉNDEZ'), clienttranslate('+3 Soldiers* & +3 Settlers'), clienttranslate('Arrival to Santiago Island. Place in area 10.')],
	14 => [6, 'title' => clienttranslate('COLUMBUS’ THIRD VOYAGE'), clienttranslate('+6 Soldiers* & +3 Settlers'), clienttranslate('Place in the same area where Columbus is located. If Columbus is not on any area, place freely between areas 5 & 6. If Columbus is in the “Prison of Spain” box, move it to the chosen area.')],
	15 => [4, 'title' => clienttranslate('FRANCISCO DE BOBADILLA'), clienttranslate('+4 Soldiers* & +3 Settlers'), clienttranslate('Place in any Spanish controlled area. In addition, place Columbus in the “Prison in Spain” box if he hasn’t been eliminated yet.')],
	16 => [2, 'title' => clienttranslate('COLUMBUS’ FOURTH VOYAGE'), clienttranslate('+2 Soldiers* & +4 Settlers'), clienttranslate('Place in an empty area or with the least number of enemy units. If Columbus is in the “Prison in Spain” box, move him to the chosen area.')],
//
